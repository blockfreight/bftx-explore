        ...
        return (
            <div style={{height: 768, width: "100%"}} className="ag-theme-balham">
                ...
                >
                    ...
                    <AgGridColumn headerName="Source">
                        ...
                        <AgGridColumn field="dob" width={110} headerName="Date of Shipment" filter="date" pinned valueFormatter={RichGridDeclarativeExample.dateCellRenderer} columnGroupShow="open"></AgGridColumn>
                    </AgGridColumn>
                    {/* the next column is not in a group, just by itself */}
                    <AgGridColumn field="progress" width={135} enableValue cellRendererFramework={ProficiencyCellRenderer}></AgGridColumn>
                    {/* then the last group with three columns */}
                    <AgGridColumn headerName="Destination">
